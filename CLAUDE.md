...
Deskctl Bridge: The programmable API for multi-OS desktop control.
...
# UI
pnpm ui               # Add shadcn to @deskctl/ui
```
...
**Note:** All package names use `@deskctl/*` scope.
...
- **Bridge**: `apps/docs/content/docs/(Deskctl)/changelog.mdx`
