---
title: FAQ
description: Common questions and use cases for Deskctl.
...
<Steps>
  ...
  <Step>
    **Dashboard Integration**: Deskctl provides raw JSON data, making it perfect for custom
...
<Callout type="warn" title="Public Alpha">
  Deskctl Bridge is currently in early development (v0.x). Features and API endpoints are
  subject to **breaking changes** without major version increments.
</Callout>
- **Updates**: Always check the [Release Notes](https://github.com/codewithevilxd/deskctl/releases) before updating.
