---
title: macOS
description: Get Deskctl Bridge running on your Mac.
icon: macos
---
## Installation
...
Download the Universal DMG from the [GitHub Releases](https://github.com/codewithevilxd/deskctl/releases):
...
<Step>
  ### Install 
  1. Open the DMG file 
  2. Drag **Deskctl Bridge** to your **Applications**
  folder
</Step>
...
2. Double-click **Deskctl Bridge**
3. The Deskctl Bridge icon will appear in your menu bar
...
To open the app:
1. Try opening **Deskctl Bridge** normally — macOS will block it
2. Go to **System Settings → Privacy & Security**
3. Scroll down and click **Open Anyway** next to the Deskctl Bridge message
...
<Callout type="warn" title="Required Permissions">
  ...
  **System Settings → Privacy & Security → Accessibility** and add Deskctl Bridge to the
  allowed apps list.
</Callout>
