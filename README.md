![Cover](https://github.com/codewithevilxd/deskctl/blob/main/github.png)

![License](https://img.shields.io/github/license/codewithevilxd/deskctl)
[![Release Bridge](https://github.com/codewithevilxd/deskctl/actions/workflows/release-bridge.yml/badge.svg)](https://github.com/codewithevilxd/deskctl/actions/workflows/release-bridge.yml)
...
| Package                           | Description                                      |
| --------------------------------- | ------------------------------------------------ |
| **[@deskctl/sdk](./packages/sdk)** | TypeScript SDK for interacting with Deskctl Bridge |
| **[@deskctl/ui](./packages/ui)**   | Shared UI components                             |
